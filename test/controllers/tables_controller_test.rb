...
class TablesControllerTest < ActionController::TestCase
  ...
  test "should create table" do
    assert_difference('Table.count') do
      post :create, table: { agenda: @table.agenda, date: @table.date, topic: @table.topic, volume: @table.volume }
    end
  ...
  test "should update table" do
    patch :update, id: @table, table: { agenda: @table.agenda, date: @table.date, topic: @table.topic, volume: @table.volume }
    assert_redirected_to table_path(assigns(:table))
  end
